...
const Index: NextPage<TProps> = ({ productData, listRelatedProduct }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Ngô Hoàng Duy - ${productData?.name}`}</title>
        <meta
          name='description'
          content={description}
        />
        <meta name='viewport' content='initial-scale=1, width=device-width' />
        <meta name="author" content="Ngô Hoàng Duy" />
        <meta name="name" content="Khóa luận tốt nghiệp 2024" />
        <meta name="image" content={productData.image} />
        {/* facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={`Ngô Hoàng Duy - ${productData?.name}`} />
        <meta property="og:description" content={description} />
        <meta property="og:image" content={productData.image} />
        {/* twitter */}
        <meta property="twitter:card" content="website" />
        <meta property="twitter:title" content={`Ngô Hoàng Duy - ${productData?.name}`} />
        <meta property="twitter:description" content={productData.description} />
        <meta property="twitter:image" content={`Ngô Hoàng Duy - ${productData?.name}`} />
      </Head>
